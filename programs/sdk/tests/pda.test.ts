...
describe("PDA Derivation", () => {
  ...
  describe("deriveExptConfigPda", () => {
    it("should derive deterministic PDA from builder key", () => {
      const [pda1, bump1] = deriveExptConfigPda(builder);
      const [pda2, bump2] = deriveExptConfigPda(builder);
    ...
    it("should match manual findProgramAddressSync", () => {
      const [pda] = deriveExptConfigPda(builder);
    ...
    it("should produce different PDAs for different builders", () => {
      ...
      const [pda1] = deriveExptConfigPda(builder);
      const [pda2] = deriveExptConfigPda(builder2);
    ...
    it("should use custom program ID when provided", () => {
      ...
      const [pdaDefault] = deriveExptConfigPda(builder);
      const [pdaCustom] = deriveExptConfigPda(builder, customProgramId);
  ...
  describe("deriveTreasuryPda", () => {
    it("should derive deterministic PDA from exptConfig key", () => {
      const [exptConfig] = deriveExptConfigPda(builder);
